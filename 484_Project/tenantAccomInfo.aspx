<%@ Page Language="C#" AutoEventWireup="true" CodeFile="tenantAccomInfo.aspx.cs" Inherits="TenantAccomInfo" %>
...
<body class="">
  ...
  <div class="main-content">
    ...
    <nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
      <div class="container-fluid">
        <!-- Brand -->
        <a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block">Space Information</a>
              ...
              <form runat="server">
                ...
                <div class="pl-lg-4">
                  ...
                  <div class="row">
                    ...
                    <asp:Button ID="ContactBtn" runat="server" Text="Contact the Host" class="mt-2 mb-4 btn btn-info" OnClick="ContactBtn_Click" ></asp:Button>   
                    <asp:Button ID="AddToFavorBtn" runat="server" Text="Add to Favorite" class="mt-2 mb-4 btn btn-info" OnClick="AddToFavorBtn_Click" ></asp:Button> 
                   <br>
                   <br>
                  <!--comment area-->
