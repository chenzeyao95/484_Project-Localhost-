<%@ Page Language="C#" AutoEventWireup="true" CodeFile="tenantDialog.aspx.cs" Inherits="tenantDialog" %>
          ...
          <div class="card bg-secondary shadow">
            <div class="card-header bg-white border-0">
              <div class="row align-items-center">
                <div class="col-8">
                  <h3 class="mb-0"><asp:Label ID="lblDetail" runat="server" Text="Messages with host"></asp:Label></h3>
                </div>
