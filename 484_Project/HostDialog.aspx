<%@ Page Language="C#" AutoEventWireup="true" CodeFile="HostDialog.aspx.cs" Inherits="HostDialog" %>
          ...
          <div class="card bg-secondary shadow">
            <div class="card-header bg-white border-0">
              <div class="row align-items-center">
                <div class="col-8">
                  <h3 class="mb-0"><asp:Label ID="lblDetail" runat="server" Text="Messages with Tenant"></asp:Label></h3>
                </div>
                <form runat="server">
                   <asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
                <div class="col-4 text-right">
                  <asp:Button id="SendLeaseBtn" class="btn btn-sm btn-primary" runat="server" Text="Send Leasing Agreement" OnClick="SendLeaseBtn_Click"></asp:Button>
                </div>
              </div>
            </div>
            <div class="card-body">
                ...
                <div class="pl-lg-4">
                  ...
                  <!--comment area-->
                    ...
                    <h3 class="mb-0"><asp:Label ID="lblHostName" runat="server" Text=""></asp:Label></h3>
                    </asp:Panel>
                    <hr class="my-4" />
                    ...
                    <asp:ListView ID="ListView1" runat="server" OnItemDataBound="ListView1_DataBound">
                        <EmptyDataTemplate>
                         ...
                         <ItemTemplate>
                             <strong><h4><%#Eval("SenderName") %></h4></strong>  
                             <asp:Panel ID="Panel4" runat="server">
                             <div class="card-body">                                                                      
                                     <tr><p style="text-align:justify"><strong><%#Eval("Text")%></strong></p>
                                         <i style="text-align:justify">Posted on <%#Eval("SendDate", "{0:MM/dd/yyyy hh:mm:ss tt}") %></i></tr>
                                 </div>
                             </asp:Panel>
                             
                             <ajaxToolkit:RoundedCornersExtender ID="RoundedCornersExtender1" runat="server" Enabled="True" TargetControlID="Panel4" Radius="10"/>
                            </ItemTemplate>
                        </asp:ListView>
                    </asp:Panel>
                    <hr class="my-4" />
                    <textarea rows="4" id="txtMessage" runat="server" class="form-control form-control-alternative" placeholder="Type your messages here..." maxlength="250"></textarea>
                    
                    <asp:Panel ID="Panel1" runat="server" HorizontalAlign="Right">
                    <asp:Button ID="vChatBtn" runat="server" Text="Video Chat" class="mt-2 mb-4 btn btn-primary" OnClick="videoChat_Click"/>
                    <asp:Button ID="SubmitBtn" runat="server" Text="Send" class="mt-2 mb-4 btn btn-info" OnClick="SendBtn_Click"/>
                    </asp:Panel>
                </div>
              </form>
