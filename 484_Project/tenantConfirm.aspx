<%@ Page Language="C#" AutoEventWireup="true" CodeFile="tenantConfirm.aspx.cs" Inherits="tenantConfirm" %>
              ...
              <form runat="server">
                ...
                <div class="pl-lg-4">
                  ...
                  <div class="row">
                    ...
                    <asp:Button ID="AcceptLeaseBtn" runat="server" Text="Accept Lease Agreement" class="mt-2 mb-4 btn btn-info" OnClick="AcceptLeaseBtn_Click" ></asp:Button> 
                   <br>
                   <br>
